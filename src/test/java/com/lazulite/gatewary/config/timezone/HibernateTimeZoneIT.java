package com.lazulite.gatewary.config.timezone;

import com.lazulite.gatewary.GatewaryApp;
import com.lazulite.gatewary.config.SecurityBeanOverrideConfiguration;
import com.lazulite.gatewary.repository.timezone.DateTimeWrapper;
import com.lazulite.gatewary.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, GatewaryApp.class})
